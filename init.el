(custom-set-variables
 ...
 '(dash-at-point-mode-alist (quote ((web-mode . "php,html,css,javascript,jquery") (javascript-mode . "javascript,jquery") (css-mode . "css") (markdown-mode . "markdown") (gfm-mode . "markdown") (apache-mode . "apache") (nginx-mode . "nginx") (puppet-mode . "puppet") (inf-ruby-mode . "ruby") (ruby-mode . "chef,vagrant,ruby") (yaml-mode . "ansible,chef") (json-mode . "chef") (erlang-shell-mode . "erl") (erlang-mode . "erl") (go-mode . "go") (cmake-mode . "cmake") (groovy-mode . "groovy") (cider-repl-mode . "clojure") (clojure-mode . "clojure") (scala-mode . "scala") (sql-mode . "mysql,psql"))))
